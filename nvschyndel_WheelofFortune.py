...
def wofTurn(playerNum):  #Done
    ...
    for unimportantNumber, p_info in players.items(): #This should be the only unused variable. Specifically dont want to show an ambiguous number reference
        for key in p_info:
